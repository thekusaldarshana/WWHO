...
*   **Unified ID Space:** Mapping SGPE tokens to a range of IDs *after* the tiktoken vocabulary (e.g., `200,019` onwards), allowing a single model to seamlessly process mixed-script text.
